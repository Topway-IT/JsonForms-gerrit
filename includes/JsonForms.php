...
class JsonForms {
	...
	public static function parserFunctionRender( Parser $parser, ...$argv ) {
		...
		$slotMetadata = self::getMetadata( $wikiPage, $named['slot'] );
		...
		$templateRender = new TemplateRender( $user, $title, $named, $slotMetadata );
...
*/
	...
	public static function getPageForm( $output, $formDescriptor ) {
		$builder = new FormBuilder( $output, $formDescriptor );
...
*/
	...
	public static function appendContent( $outputPage ) {		
		BaseRender::appendContent( $outputPage );
	}
